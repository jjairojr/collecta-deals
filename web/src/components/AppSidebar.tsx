...
function GameSwitcher({
  ...
  return (
    <div className="sticker sticker-sm grid grid-cols-4 gap-1 rounded-[12px] bg-page p-1">
      {games.map((g) => {
        ...
        return (
          <button
            ...
            title={g.name}
            className={cn(
              "font-pixel rounded-full border-2 px-1 py-2 text-[10px] transition-colors",
